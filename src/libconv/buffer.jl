...
function create_buffer_from_bytes_1d_f64(data_ptr::Ptr{UInt8}, length::Int)::Ptr{CBuffer}
	ccall(
		dlsym(libconv_runtime_handler[], :create_buffer_from_bytes_1d_f64),
		Ptr{CBuffer},
		(Ptr{UInt8}, Cint),
		data_ptr, length,
	)
...
function create_buffer_from_bytes_1d_f32(data_ptr::Ptr{UInt8}, length::Int)::Ptr{CBuffer}
	ccall(
		dlsym(libconv_runtime_handler[], :create_buffer_from_bytes_1d_f32),
		Ptr{CBuffer},
		(Ptr{UInt8}, Cint),
		data_ptr, length,
	)
...
function create_buffer_from_bytes_2d_f64(data_ptr::Ptr{UInt8}, rows::Int, cols::Int)::Ptr{CBuffer}
	ccall(
		dlsym(libconv_runtime_handler[], :create_buffer_from_bytes_2d_f64),
		Ptr{CBuffer},
		(Ptr{UInt8}, Cint, Cint),
		data_ptr, rows, cols,
	)
...
function create_buffer_from_bytes_2d_f32(data_ptr::Ptr{UInt8}, rows::Int, cols::Int)::Ptr{CBuffer}
	ccall(
		dlsym(libconv_runtime_handler[], :create_buffer_from_bytes_2d_f32),
		Ptr{CBuffer},
		(Ptr{UInt8}, Cint, Cint),
		data_ptr, rows, cols,
	)
...
function destroy_buffer(buffer::Ptr{CBuffer})
	ccall(
		dlsym(libconv_runtime_handler[], :destroy_buffer),
		Cvoid,
		(Ptr{CBuffer},),
		buffer,
	)
...
function buffer_getindex_1d_f64(buffer::Ptr{CBuffer}, index::Int)::Float64
	ccall(
		dlsym(libconv_runtime_handler[], :buffer_getindex_1d_f64),
		Cdouble,
		(Ptr{CBuffer}, Cint),
		buffer, index - 1,
	)
...
function buffer_getindex_1d_f32(buffer::Ptr{CBuffer}, index::Int)::Float32
	ccall(
		dlsym(libconv_runtime_handler[], :buffer_getindex_1d_f32),
		Cfloat,
		(Ptr{CBuffer}, Cint),
		buffer, index - 1,
	)
...
function buffer_getindex_2d_f64(buffer::Ptr{CBuffer}, row::Int, col::Int)::Float64
	ccall(
		dlsym(libconv_runtime_handler[], :buffer_getindex_2d_f64),
		Cdouble,
...
function buffer_getindex_2d_f32(buffer::Ptr{CBuffer}, row::Int, col::Int)::Float32
	ccall(
		dlsym(libconv_runtime_handler[], :buffer_getindex_2d_f32),
		Cfloat,
		(Ptr{CBuffer}, Cint, Cint),
		buffer, row - 1, col - 1,
	)
...
function buffer_setindex_1d_f64(buffer::Ptr{CBuffer}, value::Float64, index::Int)
	ccall(
		dlsym(libconv_runtime_handler[], :buffer_setindex_1d_f64),
		Cvoid,
...
function buffer_setindex_1d_f32(buffer::Ptr{CBuffer}, value::Float32, index::Int)
	ccall(
		dlsym(libconv_runtime_handler[], :buffer_setindex_1d_f32),
		Cvoid,
...
function buffer_setindex_2d_f64(buffer::Ptr{CBuffer}, value::Float64, row::Int, col::Int)
	ccall(
		dlsym(libconv_runtime_handler[], :buffer_setindex_2d_f64),
		Cvoid,
...
function buffer_setindex_2d_f32(buffer::Ptr{CBuffer}, value::Float32, row::Int, col::Int)
	ccall(
		dlsym(libconv_runtime_handler[], :buffer_setindex_2d_f32),
		Cvoid,
